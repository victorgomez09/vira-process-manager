...
exports.options = [
    ...
    },
    {
        ...
        description: "Stop the daemon, ungracefully killing any remaining processes. " +
            ...
            "Use {italic 'vira-pm --wait --kill stop all'} to achieve a graceful stop.",
        defaultValue: false
    },
    {
        name: 'wait',
        type: Boolean,
        description: "Wait for any pending actions to complete. This means vira-pm will only return once " +
    ...
    },
    {
        name: 'force',
        type: Boolean,
        description: "Make vira-pm ignore some safeguards. (I hope you know what you're doing)",
        defaultValue: false
    },
    {
        name: 'no-upload',
...
exports.help = [
    {
        header: "Options",
        content: [
            "# vira-pm [--config {underline File|Folder}] [{underline Action} {underline Select}...]"
        ]
    },
    {
    ...
    },
    {
        content: {
            ...
            data: [
                ...
                { col: "{italic vira-pm --config sample-config.js start myApp}\n" }
...
exports.configuration = [
    {
        ...
        content: [
            ...
            "By default all applications use the simple file-logger that ships with vira-pm, but creating a custom logger is very simple. " +
